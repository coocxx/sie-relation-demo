...
public interface IDemoUser extends IBaseCommon<DemoUserEntity_HI> {
    ...
    //Pagination<DemoUserEntity_RO> findRoPagination(JSONObject jsonObject, Integer pageIndex, Integer pageRows, OrderByBean orderByBean);
    Pagination<DemoUserEntity_RO> findRoUser(JSONObject jsonObject, Integer pageIndex, Integer pageRows, OrderByBean orderByBean);
}
